...
const Header = () => {
  ...
  return (
    <header>
      <Navbar style={{ backgroundColor: '#003840' }} variant='dark' expand='lg' collapseOnSelect >
        <Container>
          <LinkContainer to='/'>
            <Navbar.Brand style={brandStyle}>
              {/* <img src={logo} alt='eBuy logo' /> */}
              <FaShoppingBag style={{ marginRight: '5px', fontSize: '24px' }} />
              <span style={brandStyle}>eBuy</span>
            </Navbar.Brand>
          </LinkContainer>
